...
@Component
public class FiltroFinalizados implements FiltroTicketsAgenteStrategy {
    ...
    public Page<TicketEtapaAgenteDetalle> aplicar(
            Agente agente, Pageable pageable,
            FiltroFechaTicketEnum fechaOp, LocalDate fecha) {

        return ticketMapper.mapearTicketsFinalizados(agente, pageable, fechaOp, fecha);
    }
}